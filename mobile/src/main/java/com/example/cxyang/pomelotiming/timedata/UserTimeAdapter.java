...
public class UserTimeAdapter extends RecyclerView.Adapter<UserTimeAdapter.UseTimeViewHolder>{
    ...
    public UserTimeAdapter(Context context, ArrayList<PackageInfo> PackageInfoList) {
        this.mPackageInfoList = PackageInfoList;
        mUseTimeDataManager = UserTimeDataManager.getInstance(context);
    }
