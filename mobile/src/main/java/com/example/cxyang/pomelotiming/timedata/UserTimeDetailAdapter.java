...
public class UserTimeDetailAdapter extends  RecyclerView.Adapter<UserTimeDetailAdapter.UseTimeDetailViewHolder>{
    ...
    public UserTimeDetailAdapter(ArrayList<OneTimeDetails> mOneTimeDetailInfoList) {
